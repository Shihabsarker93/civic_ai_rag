...
Figures~\ref{fig:architecture} and \ref{fig:answer-architecture} present the implemented architecture using corrected exports of the supplied draw.io design. The panels retain the original flow while clarifying terminology and component limits. Figure~\ref{fig:evaluation-architecture} separates the two evaluation designs from the online chatbot.
