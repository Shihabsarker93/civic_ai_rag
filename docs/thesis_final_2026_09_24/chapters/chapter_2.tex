...
\paragraph{Dense Retrieval, Lexical Retrieval and Fusion.}
...
\paragraph{Reranking and Context Selection.}
...
\paragraph{NextRAG: Principal Architectural Inspiration.}
...
\paragraph{Multilingual Embeddings and Local Generators.}
...
\paragraph{Context Distraction and Diagnostic Evaluation.}
...
\paragraph{Other Bangla RAG Approaches.}
...
\paragraph{Automatic RAG Evaluation.}
